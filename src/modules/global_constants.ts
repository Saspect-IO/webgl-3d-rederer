export enum ProgramEntrySettings {
    ...
    PATH_ASSETS_SPHERE = '/assets/resources/Mandalorian_Helmet/source/Mandalorian_Helmet.obj',
    PATH_ASSETS_DIFFUSE = '/assets/resources/Mandalorian_Helmet/textures/mandalorianUV2_Helmet_BaseColor.png',
